...
const CategoryCard = ({ category, money }) => {
    ...
    switch (category) {
        ...
        case "Entertainment":
                case 2: 
                    return {
                    ctg : "Entertainment",
                    icon: <IoGameControllerOutline style={{ color: "#e4f1ds"}} />,
                    background: "#92c44c",
                    };
  ...
  return <div className={styles.container} style={{background: style.background}}>
   <div className={style.inner}>
   <div className={style.iconContainer}>{style.icon}</div>
